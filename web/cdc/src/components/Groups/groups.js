        ...
        <>
            ...
            <div className={`${classes.wrapperBlocks}`}>
                ...
                <div className={`${classes.leftBlock}`}>
                    <div className={`${classes.groupsControlPanel}`}>
                        <div className={`${classes.panelAddGroup}`}>
                            <p>Группы</p>
                            <button className={`${classes.panelAddGroupButton}`}>
                            <img src={add} alt="add" />
                            </button>
                        </div>
                    ...
                    <ul className={`${classes.groupsTable}`}>
                    <li>
                    {/* onClick={() => {
                ...
                <div className={`${classes.rightBlock}`}>
                    <div className={`${classes.groupInfoHeading}`}>
                    <div className={`${classes.headingTitle}`}>
                        <p>Группа:</p>
                        <div className={`${classes.headingTitleGroupName}`}>Spauspauspau</div>
                    </div>

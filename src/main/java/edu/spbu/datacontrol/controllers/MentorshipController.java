...
public class MentorshipController {
  ...
  @PostMapping("/add")
  public ResponseEntity<String> addMentorship(@RequestBody User mentor, @RequestBody User mentee,
      @RequestBody Date disbandmentDate) {
    if (mentor.getMentorStatus() == MentorshipStatus.MENTOR && mentee.getMentorStatus() == MentorshipStatus.MENTEE) {
      ...
      return new ResponseEntity<>("The mentor or mentee is incorrectly specified.",
